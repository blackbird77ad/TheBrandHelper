...
export default function Services() {
  return (
    <div className="bg-white text-black overflow-x-hidden">
      <Helmet>
        <title>Services | The Brand Helper- Web Agency</title>
        <meta name="description" content="Website design, ads management, brand strategy, business email, consulting, and supporting services from The Brand Helper." />
      </Helmet>
      ...
      <section className="py-16 md:py-20 bg-white px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              { num: "01", title: "40% deposit to start",       desc: "Sent via Payoneer invoice- no Payoneer account needed. You pay by bank transfer, card, or mobile money." },
